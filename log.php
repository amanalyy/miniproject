    ...
    if (mysqli_num_rows($result) == 1)
        {
            ...
            echo"<meta http-equiv = 'refresh' content = '0; url = parent.php'>";
                ...
                elseif(row['role'] == 'baby sitter'){
                    echo"<meta http-equiv = 'refresh' content = '0; url = babysitters.php'>";
                }
                else{
...
<body>
    ...
    <div class="box">
            ...
            <form action= "log.php" method="POST"> 
                ...
                value="babysitter" checked > Baby Sitter<br>
                    <input type="radio" name="role"
                value="parent" > Parent <br><br>
                ...
                <div class="inputBox">
                     ...
                     <input type = "password" naame = "password" required="">

                <br>
                    
                    
                </div>
                <input type="submit" name="" value="Submit" @click="submit"> <br><br>
